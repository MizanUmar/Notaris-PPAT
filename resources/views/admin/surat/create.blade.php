...
@section('title', 'Buat Surat - Notaris Eka Sulistya')
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 border-end" style="max-height: 800px; overflow-y: auto; padding-right: 20px;">
                    ...
                    <p class="text-muted small">Sesuaikan parameter di bawah ini. Tekan tombol kuning untuk mempopulerkan isi draft surat resmi.</p>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted d-block mt-1">Pilih jenis draf untuk memuat parameter dan format surat yang diinginkan secara dinamis.</small>
                    </div>
                ...
                <div class="col-lg-8 ps-lg-4">
                    ...
                    <form method="POST" action="{{ route('admin.surat.store', $permintaan->id) }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nomor_surat" class="form-control @error('nomor_surat') is-invalid @enderror" value="{{ old('nomor_surat') }}" required placeholder="Contoh: 01/SKR/NOT/ES/VIII/2025">
                                    @error('nomor_surat')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jenis_surat" class="form-control @error('jenis_surat') is-invalid @enderror" value="{{ old('jenis_surat') }}" required placeholder="Contoh: Surat Kuasa">
                                    @error('jenis_surat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="editor" name="isi_surat" class="@error('isi_surat') is-invalid @enderror">{{ old('isi_surat') }}</textarea>
                            @error('isi_surat')
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            ...
                            <button type="submit" class="btn btn-primary fw-bold px-4">
                                <i class="fa fa-save me-1"></i> Simpan Surat
                            </button>
                        </div>
                    </form>
                </div>
  ...
  <tr>
    ...
    function renderFields() {
        ...
        if (selectedDraft === 'kuasa') {
            ...
            // Surat Pernyataan Pemasangan Batas
            html = `
                <div class="mb-3">
                    <label class="form-label small fw-bold">Tanggal TTD (Lengkap)</label>
                    <input type="text" id="param_tanggal_lengkap" class="form-control form-control-sm" value="02 Oktober 2025">
