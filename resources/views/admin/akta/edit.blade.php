        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 border-end" style="max-height: 800px; overflow-y: auto; padding-right: 20px;">
                    ...
                    <p class="text-muted small">Sesuaikan parameter di bawah ini jika ingin menyusun ulang draft akta. Tekan tombol kuning untuk mempopulerkan isi draft akta. <strong>Isi akta di sebelah kanan sudah memuat versi yang tersimpan sebelumnya</strong>, jadi tombol ini hanya perlu ditekan bila Anda ingin mengganti seluruh isi.</p>
                ...
                <div class="col-lg-8 ps-lg-4">
                    ...
                    <form method="POST" action="{{ route('admin.akta.update', $akta->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nomor_akta" class="form-control @error('nomor_akta') is-invalid @enderror" value="{{ old('nomor_akta', $akta->nomor_akta) }}" required placeholder="Contoh: 01">
                                    @error('nomor_akta')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_akta" class="form-control @error('nama_akta') is-invalid @enderror" value="{{ old('nama_akta', $akta->nama_akta) }}" required placeholder="Contoh: Akta Pendirian PT">
                                    @error('nama_akta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-muted small">Ganti File Akta Digital (Kosongkan agar PDF dibuat ulang otomatis dari Isi Akta di bawah)</label>
                            <input type="file" name="file_akta" class="form-control @error('file_akta') is-invalid @enderror">
                            @error('file_akta')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
<p>memparaf dan menandatangani akta ini, serta untuk memenuhi Ketentuan pasal 16 (enambelas) ayat 1(satu) huruf C Undang-Undang Republik Indonesia Nomor 30 (tiga puluh) Tahun 2004 (duaribu empat) tentang jabatan Notaris sebagaimana yang telah diubah dengan Undang-Undang Republik Indonesia Nomor 2 (dua) Tahun 2014 (duaribu empatbelas), maka para Penghadap juga membubuhkan sidik jari pada lembaran tersendiri untuk dilekatkan pada minuta akta ini.------------- Dilangsungkan dengan tanpa perubahan.-------------- Minuta  akta  ini  telah   ditandatangani   dengan sempurna.------------------------------------------ -- DIBERIKAN SEBAGAI SALINAN YANG SAMA BUNYINYA -–  NOTARIS KOTA PONTIANAK    (EKA SULISTYA, S.H., M.Kn.)</p>`;
    ...
    ClassicEditor
        ...
        .then(editor => {
            ...
            // memanggil compileDeed() secara otomatis saat halaman dibuka,
            // karena editor sudah terisi isi_akta yang tersimpan sebelumnya
            // dan kita tidak ingin menimpanya tanpa sepengetahuan user.
            ...
            function compileDeed() {
                ...
                // Set CKEditor content -- ini yang menimpa isi_akta lama
            ...
            // Bind change event to dropdown to dynamically update left-side fields
            // (tidak otomatis compile ke editor, hanya menampilkan field yang relevan)
            selectDraft.addEventListener('change', function() {
                renderFields();
            });

            // Bind click event to apply button -- ini satu-satunya cara
            // isi editor lama tertimpa oleh template baru
